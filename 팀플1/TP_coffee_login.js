...
let userId = sessionStorage.getItem('inputid'); //회원가입 페이지에서 가져온 아이디
let userPw = sessionStorage.getItem('inputpassword');//회원가입 페이지에서 가져온 비밀번호
let username = sessionStorage.getItem('inputname');//회원가입 페이지에서 가져온 사용자 이름
